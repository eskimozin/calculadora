...
function Home() {
  ...
  const subathonInitComponent = moment().diff(moment(subathonInit), "seconds") > 0 ? "A live está no ar!" : (<>A live começa em {Util.renderText(moment(subathonInit).format("DD/MM/YYYY [às] HH:mm [UTC]Z"))}.</>);
